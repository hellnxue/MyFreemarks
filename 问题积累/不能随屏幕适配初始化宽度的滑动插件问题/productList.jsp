...
<body>
	...
	<form action="credit_card_02" method="post"  data-ajax="false">
	    ...
	    <div class='form-group pd_area_t_je'>
            ...
            <input name="repaymentPeriod" value="" type="text">
            <input name="productCode" value="" type="text">
            <input name="productName" value="" type="text">
            <input name="poundage" value="" type="text">
            <input name="capital" value="" type="text">
        </div>
