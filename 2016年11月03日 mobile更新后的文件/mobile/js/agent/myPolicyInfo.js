...
function policyInfo() {
	...
	html += '<div class="bdlb_21_div" onclick="policyDetail('+1+')">';
	html += '<p  class="titile_p">保单号<span>'+2+'</span></p>';
	html += '<div class="bdlb_21_div_con">';
	html += '<p class="height_1"></p>';
	html += '<p>保单名称：'+3+'</p>';
	html += '<div class="div_f_w45">投保人姓名：'+4+'</div>';
	html += '<div class="div_f_w55">被保人姓名：'+5+'</div>';
	html += '<div class="div_f_w45">保单状态：'+6+'</div>';
	html += '<div class="div_f_w55">承保日期：'+7+'</div>';
	html += '<p class="height_1"></p>';
	html += '</div>';
