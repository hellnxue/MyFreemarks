...
//	}
	...
	request.faceIdCard = '/emploan/img/customerIdCard/2016111416190455532878.jpg'; //身份证正面照片key
	request.rearIdCard = '/emploan/img/customerIdCard/2016111416191082326985.jpg'; //身份证背面照片key
	request.handIdCard = '/emploan/img/customerIdCard/2016111416191855145921.jpg'; //手持身份证照片key
	request.productCode = '600';
	CommonUtil.executeAjax("0100006",request,function(data) {
